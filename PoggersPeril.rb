...
def starting_room
  ...
  while true
    ...
    if choice == "open door" && !key_taken
      ...
      dead("You unlock the door with the key. It swings open suddenly, exposing your naked body to the guard in front of you. As he is a good Catholic man who doesn't want to be seen as gay, he doesn't hesitate in stabbing you.")
    elsif choice == "use key on door" && key_taken && clothes_on
